        ...
        <form method="post" action="{{route('products.update', $product->id)}}" enctype="multipart/form-data">
            ...
            <div class="card">
                <div>
                    ...
                    <textarea cols="10" rows="5" name="description" vlaue="{{ $product->description }}">{{ $product->description }}</textarea>
                ...
                <div>
                    ...
                    <select name="category">
                        @foreach(json_decode('{"Smartphone":"SamrtPhone","Smart TV":"Smart TV", "Computer":"Computer"}', true) as $optionKey => $optionValue)
